...
id: "shark2authdog"
name: "shark2authdog"
description: "A python tool to parse Kerberos Pre-Authentication (PA) hashes (krb5pa)"
priority: 10
---
<h1 style="color: #5dc9ff;">🦈shark2authdog🌭</h1>

[Github repository](https://github.com/ariannelafraise/kerberos-hash-parser)↗

A python tool to parse Kerberos Pre-Authentication (PA) hashes (krb5pa), from Wireshark capture files

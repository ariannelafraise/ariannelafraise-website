...
id: "shark2authdog"
name: "shark2authdog"
description: "A python script to parse Kerberos Pre-Authentication (PA) hashes (krb5pa), from Wireshark capture files containing KRB5 AS-REQ packets. These can be given to either hashcat or john the ripper to crack the user's password."
priority: 10
---
# shark2authdog

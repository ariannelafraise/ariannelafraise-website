---
id: "kerberos-hash-parser"
name: "Kerberos hash parser"
description: "A python script to parse Kerberos hashes, from Wireshark capture files containing KRB5 AS-REQ packets, that can be cracked into the user's password using hashcat and john the ripper."
priority: 10
---
...
2. Launch:
```bash
python khp.py <file> <output_format: 'hashcat' or 'john'>
```

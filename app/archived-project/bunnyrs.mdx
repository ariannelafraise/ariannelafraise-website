...
[Github repository](https://github.com/ariannelafraise/bunnyrs)↗

## Preview

### Reverse Shell
![preview of bunnyrs reverse shell profile](https://github.com/ariannelafraise/bunnyrs/raw/main/media/preview-reverse-shell.png)

### Execute
![preview of bunnyrs execute profile](https://github.com/ariannelafraise/bunnyrs/raw/main/media/preview-execute.png)

## Usage

Can run in two modes: Client or Server

. ݁₊ ⊹ . **NOTE: Use CTRL+C to terminate bunnyrs in any mode.** ⟡ ݁ . ⊹ ₊ ݁.
